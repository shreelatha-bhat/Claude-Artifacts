...
4. **Specify contract** — Create OpenAPI 3.1 spec; validate before proceeding:
   ```bash
   npx @redocly/cli lint openapi.yaml
   ```
5. **Mock and verify** — Spin up a mock server to test contracts:
   ```bash
...
REST architecture, OpenAPI 3.1, GraphQL, HTTP semantics, JSON:API, HATEOAS,
OAuth 2.0, JWT, RFC 7807 Problem Details, API versioning patterns, pagination
strategies, rate limiting, webhook design, SDK generation

## Contributor Information
Name: Sonal Monis
Department: Engineering CNE